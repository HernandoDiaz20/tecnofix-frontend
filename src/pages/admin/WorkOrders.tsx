...
export const WorkOrders: React.FC = () => {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-[#191C1E] tracking-tight">Órdenes de Servicio</h1>
        <p className="text-[#434655]">Listado y gestión de todas las órdenes en el taller.</p>
      </div>
