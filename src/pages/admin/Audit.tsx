...
export const Audit: React.FC = () => {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-[#191C1E] tracking-tight">Auditoría</h1>
        <p className="text-[#434655]">Registro de logs y actividades del sistema.</p>
      </div>
      ...
      <Card className="border-[#E0E3E5] shadow-sm bg-white">
        <CardContent className="flex flex-col items-center justify-center py-20 text-center">
          <div className="w-16 h-16 rounded-full bg-[#E6E8EA] flex items-center justify-center mb-4">
            <FileSearch className="w-8 h-8 text-[#434655]" />
          </div>
